...
import { Sun, Moon, Settings as SettingsIcon, PiggyBank } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4">
      <header className="max-w-md mx-auto flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold flex items-center gap-2" onClick={handleGoHome} style={{ cursor: 'pointer' }}>
          Ma Tirelire <PiggyBank className="text-pink-500" />
        </h1>
